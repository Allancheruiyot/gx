...
/**
   ...
   $sales = DB::table('erporders')
    ...
    {   
    $message->from('info@gx.co.ke', 'Gas Express');
    $message->to('victor.kotonya@gx.co.ke', 'Victor Kotonya')->cc('victor.kotonya@gmail.com', 'Victor Kotonya')->cc('accounts@gx.co.ke', 'Vic Bett')->cc('mikenyangore91@gmail.com', 'Mike Nyangare')->subject('Daily Sales Report!');
    //$message->to('chrispus.cheruiyot@lixnet.net', 'Crispus')->subject('Daily Sales Report!');
    $message->attach($filePath.$fileName);
...
public function sendMail_net(){
   ...
   echo 'Net Report Successfully Sent!';
    ...
    {   
    $message->from('info@gx.co.ke', 'Gas Express');
    $message->to('victor.kotonya@gx.co.ke', 'Victor Kotonya')->cc('victor.kotonya@gmail.com', 'Victor Kotonya')->cc('chrispus.cheruiyot@lixnet.net', 'Crispus Cheruiyot')->cc('wangoken2@gmail.com', 'Ken Wango')->subject('Client Balances!');
    //$message->to('chrispus.cheruiyot@lixnet.net', 'Crispus Chevarvar')->subject('Daily Sales Report!');
    $message->attach($filePath.$fileName);
